...
<body>
                ...
                >
                    <div class="w3-bar-block sideMenuDiv" style="margin-bottom:100px;">
                        ...
                        <a href="<?php echo base_url()?>admin/gallery" style="color:#FFFFFF;">
                            <img src="<?php echo base_url() ?>static/img/bg/bg1.png" class="overlay-div" />
                            <span>Gallery Images<i id="side-menu-triangle-6" class="fa fa-caret-left fa-4x w3-right w3-text-white side-menu-triangle" style="display:block"></i></span>
                        </a>
                        </div>
                ...
                <div class="w3-rest" style="position:relative;">
                    ...
                    <div id="content-container-4" class="w3-col content-container w3-animate-opacity" style="position:relative; display:block;">
                        <div class="w3-col w3-center w3-theme content-container-admin">
                                    ...
                                    <span class="w3-xlarge">Gallery</span>
                            ...
                            <div class="w3-col w3-padding w3-padding-16 w3-white" style="min-height:561px;">
                                <button type="button" id="ntfAddBtn" onclick="open_add_gallery_modal();" class="w3-btn w3-block w3-theme-1 w3-round w3-padding">
                                <i class="fa fa-plus"></i>  Add Gallery Image</button>
                                <br><p></p>
                                    ...
                                    <table class="w3-table-all w3-table-sm">
                                        ...
                                        <tbody id="notification_tbody">
                                            ...
                                            <?php foreach($list as $k=> $_row):
                                                ...
                                                ?>
                                                <tr>
                                                    <td><img src="<?php echo base_url().'static/'.$_row['image_path'];?>" width="120px;"></td>
                                                    <td><?php echo base_url().'static/'.$_row["image_path"]; ?></td>
                                                    <td></td>
                                                    <td><button type="button" onclick="delete_gallery('<?php echo $id;?>');" class="w3-btn w3-theme-1 w3-round w3-tiny" style="background-color:#eeeeee !important; color:#000000 !important;">Delete</button></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>static/js/carousel.js?v=23"></script>
    <script>
