                ...
                <div class="w3-rest" style="position:relative;">
                    ...
                    <div id="content-container-4" class="w3-col content-container w3-animate-opacity" style="position:relative; display:block;">
                        <div class="w3-col w3-center w3-theme content-container-admin">
                                    ...
                                    <span class="w3-xlarge">Carousel</span>
                            ...
                            <div class="w3-col w3-padding w3-padding-16 w3-white" style="min-height:561px;">
                                <button type="button" id="ntfAddBtn" onclick="open_add_carousel_modal();" class="w3-btn w3-block w3-theme-1 w3-round w3-padding">
                                <i class="fa fa-plus"></i>  Add Carousel Image</button>
                                <br><p></p>
                                        ...
                                        <tbody id="notification_tbody">
                                            ...
                                            <?php foreach($list as $k=> $_row): 
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><button type="button" onclick="delete_carousel('<?php echo $id;?>');" class="w3-btn w3-theme-1 w3-round w3-tiny" style="background-color:#eeeeee !important; color:#000000 !important;">Delete</button></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
