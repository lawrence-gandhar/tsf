                ...
                <div class="w3-rest" style="position:relative;">
                    ...
                    <div id="content-container-4" class="w3-col content-container w3-animate-opacity" style="position:relative; display:block;">
                        <div class="w3-col w3-center w3-theme content-container-admin">
                                    ...
                                    <span class="w3-xlarge">Examinations</span>
                                </div>
                            <div class="w3-col w3-padding w3-padding-16 w3-white" >
                                <div class="w3-col w3-responsive w3-responsive-sm" style="max-height:100% !important;">
                                    <form action="<?php echo base_url()?>admin/examinations/add" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12 control-label" for="total_question"></label>
                                            <div class="col-md-12">
                                                <input id="total_questions" name="total_questions" placeholder="Enter total number of questions" class="form-control input-md" type="number">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12 control-label" for="total_marks"></label>
                                            <div class="col-md-12">
                                                <input id="total_marks" name="total_marks" placeholder="Enter marks on right answer" class="form-control input-md" min="0" type="number">
                                            </div>
                                        </div>
                                        <div class="form-group">
